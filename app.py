...
sym_des = pd.read_csv("datasets/symptoms/symtoms_df.csv")
precautions = pd.read_csv("datasets/symptoms/precautions_df.csv")
workout = pd.read_csv("datasets/symptoms/workout_df.csv")
description = pd.read_csv("datasets/symptoms/description.csv")
medications = pd.read_csv('datasets/symptoms/medications.csv')
diets = pd.read_csv("datasets/symptoms/diets.csv")
...
# @app.route('/paramerarise prediction')
# def paramerarise prediction():
...
def heart_disease():
    if request.method == 'POST':
        ...
        if prediction == 1:
            result = "You have a high risk of heart disease."
        else:
            result = "You have a low risk of heart disease."
